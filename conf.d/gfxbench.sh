...
TESTS[FILL]='MESA_GLSL_VERSION_OVERRIDE=400 MESA_GL_VERSION_OVERRIDE=4.1 gfxbench40 gl_fill2 $GFXB40_PATH'
TESTS[FILL_O]='MESA_GLSL_VERSION_OVERRIDE=400 MESA_GL_VERSION_OVERRIDE=4.1 gfxbench40 gl_fill2_off $GFXB40_PATH'
TESTS[TREX]='gfxbench40 gl_trex $GFXB40_PATH'
TESTS[TREX_O]='gfxbench40 gl_trex_off $GFXB40_PATH'
TESTS[MANHATTAN]='MESA_GLSL_VERSION_OVERRIDE=400 MESA_GL_VERSION_OVERRIDE=4.1 gfxbench40 gl_manhattan $GFXB40_PATH'
TESTS[MANHATTAN_O]='MESA_GLSL_VERSION_OVERRIDE=400 MESA_GL_VERSION_OVERRIDE=4.1 gfxbench40 gl_manhattan_off $GFXB40_PATH'
